...
- receiver-key proof, ballot proof record, and claim-bearing encoded-score ballot package verification through the packaged Rust/WASM backend
...
- you need to verify supported receiver-key proofs, ballot proof records, or claim-bearing encoded-score ballot packages
