...
- receiver-key proof, ballot proof-record, and proof-byte-bearing claim-bearing package verification through the packaged Rust/WASM backend
...
- you need to verify supported receiver-key proofs, ballot proof records, or proof-byte-bearing claim-bearing packages
