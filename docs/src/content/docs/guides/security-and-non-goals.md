...
- ballot privacy verification covers receiver-key proof, ballot proof-record, and proof-byte-bearing scoped relation package checks for the documented M5 relation scope only
...
- treat the current public package as transcript-core fixture verification, election foundation checks, receiver-key proof verification, ballot proof-record verification, and proof-byte-bearing scoped relation package verification, not as a usable voting library yet
