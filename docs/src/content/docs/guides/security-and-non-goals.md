...
This page intentionally does not maintain a separate threat model, open-issue ledger, retry policy, audit statement, or cryptographic caveat list. Use the repository policy before treating any verification result as security evidence.
