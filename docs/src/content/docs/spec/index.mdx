...
- The current public runtime facade exposes only the transcript-core fixture verifier.
- No public subpaths are promised yet.
- The published package exists to stabilize packaging, docs, smoke checks, transcript-core fixtures, and release flow before wider APIs are introduced.
