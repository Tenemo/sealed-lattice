...
use super::{
    ...
    PROOF_APPLICATION_SLOT_SCHEMA_IDENTIFIER, PROOF_AUTHENTICATION_FRONTIER_SCHEMA_IDENTIFIER,
    PROOF_AUTHENTICATION_NODE_SCHEMA_IDENTIFIER, PROOF_FAMILY_PROFILE_SCHEMA_IDENTIFIER,
    PROOF_FIELD_PROFILE_SCHEMA_IDENTIFIER, PROOF_FIELD_SCHEDULE_SCHEMA_IDENTIFIER,
    PROOF_MERKLE_NODE_SCHEMA_IDENTIFIER, PROOF_MERKLE_TREE_CONTEXT_SCHEMA_IDENTIFIER,
    PROOF_OBJECT_HEADER_SCHEMA_IDENTIFIER, PROOF_ORACLE_PHASE_PAIR_LEAF_SCHEMA_IDENTIFIER,
    PROOF_PROFILE_SET_SCHEMA_IDENTIFIER, PROOF_QUERY_OPENING_RECORD_SCHEMA_IDENTIFIER,
    PersistentProofCoinInput, ProofApplicationBinding, ProofApplicationSlot, ProofFamilyProfile,
    ProofFieldProfile, ProofFieldSchedule, ProofObjectHeader, ProofProfileSet,
...
pub(crate) fn validate_foundation_schema_object(
    ...
    let reencoded = match schema_identifier {
        ...
        PROOF_APPLICATION_SLOT_SCHEMA_IDENTIFIER => reencode_schema!(ProofApplicationSlot),
        PROOF_APPLICATION_BINDING_SCHEMA_IDENTIFIER => reencode_schema!(ProofApplicationBinding),
        ...
        PERSISTENT_PROOF_COIN_INPUT_SCHEMA_IDENTIFIER => {
            reencode_schema!(PersistentProofCoinInput)
        }
        ORDINARY_PROOF_COIN_INPUT_SCHEMA_IDENTIFIER => {
            reencode_schema!(OrdinaryProofCoinInput)
        }
