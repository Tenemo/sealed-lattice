...
fn exact_setup_generation_evidence_inputs(
    ...
    action_context_bytes[Hash512::BYTE_LENGTH - 1] = evidence_revision;
    ...
    action_randomness_root_bytes[ACTION_RANDOMNESS_ROOT_BYTE_LENGTH - 1] = evidence_revision;
    ...
    let verified_public_randomness =
        VerifiedPublicRandomness::from_exact_same_secret_evidence_values(
            VerifiedSetupVerificationContext::for_exact_same_secret_evidence(
                suite_identifier,
                manifest_hash,
                ceremony_context_hash,
                action_context_hash,
    ...
    let verified_reservation_binding = VerifiedStateReservationRuntimeBinding {
        authorization_hash,
        durable_binding: StateDurableBinding::for_exact_same_secret_evidence(
            suite_identifier,
            ceremony_context_hash,
            action_context_hash,
            local_participant_identity,
