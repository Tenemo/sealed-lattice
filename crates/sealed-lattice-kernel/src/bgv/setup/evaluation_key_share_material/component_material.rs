...
#[cfg(test)]
pub(in crate::bgv::setup) fn encode_evaluation_key_share_component_vectors(
    level: usize,
    ring_degree: usize,
...
#[cfg(test)]
pub(in crate::bgv::setup) struct KeySwitchComponentBFixtureInput<'a> {
    pub(in crate::bgv::setup) key_switch_domain: &'a str,
    pub(in crate::bgv::setup) key_switch_seed_hex: &'a str,
    pub(in crate::bgv::setup) digit_index: usize,
    pub(in crate::bgv::setup) source_coefficients: &'a [i128],
    pub(in crate::bgv::setup) secret_coefficients: &'a [i64],
    pub(in crate::bgv::setup) error_coefficients: &'a [i64],
