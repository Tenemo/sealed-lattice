...
use self::record_rebinding::{
    ...
    rebind_collective_he_security_certificate_hash, rebind_collective_phase_roots,
    ...
    rebind_same_secret_proof_record_root, rebind_setup_assembly_provenance_certificate,
