...
use crate::{
    bgv::{
        ...
        direct_ballots::{
            ...
            direct_ballot_verifier_certificate_hash, direct_ballot_verifier_certificate_value,
...
pub(crate) fn describe_bgv_rns_profile() -> CanonicalResult<Value> {
    Ok(json!({
        ...
        "directBallotSoundnessCertificate": direct_ballot_soundness_certificate_value()?,
        "directBallotSoundnessCertificateHash": direct_ballot_soundness_certificate_hash()?,
        "directBallotZeroKnowledgeCertificate": direct_ballot_zero_knowledge_certificate_value()?,
        "directBallotZeroKnowledgeCertificateHash": direct_ballot_zero_knowledge_certificate_hash()?,
        "directBallotVerifierCertificate": direct_ballot_verifier_certificate_value()?,
        "directBallotVerifierCertificateHash": direct_ballot_verifier_certificate_hash()?,
