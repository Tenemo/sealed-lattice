...
// The hybrid key-switch special basis. These are the first seventeen distinct
// 47-bit primes below 2^47 that are one modulo 2N. Their product exceeds the
// complete data-basis product, so the one-block hybrid decomposition does not
// enlarge the decomposed key-switch error before exact modulus-down.
pub(crate) const SPECIAL_PRIMES: [u64; 17] = [
    140_737_487_306_753,
    140_737_486_716_929,
    140_737_486_520_321,
    140_737_485_864_961,
...
// an RNS limb; entries [1..] cover the 17 data primes then the 17 special primes.
pub(crate) const ROOT_PARAMETERS: [RootParameters; 35] = [
    RootParameters {
        modulus: 65_537,
