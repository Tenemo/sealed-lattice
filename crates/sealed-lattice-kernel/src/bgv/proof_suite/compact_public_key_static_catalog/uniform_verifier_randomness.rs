        ...
        assert_eq!(
            ...
            vec![
                UniformRandomnessSnapshot {
                    packing_factor: 1,
                    total_fixed_candidate_slot_count: 1_188_224,
                    total_uniform_message_byte_length: 10_401_792,
                    concrete_challenge_stream_hash_query_count: 162_610,
                    field_sampling_exhaustion_security_bit_floor_per_attempt: 4_088,
                },
                UniformRandomnessSnapshot {
                    packing_factor: 2,
                    total_fixed_candidate_slot_count: 1_207_936,
                    total_uniform_message_byte_length: 10_545_152,
                    concrete_challenge_stream_hash_query_count: 164_848,
                    field_sampling_exhaustion_security_bit_floor_per_attempt: 4_088,
                },
                UniformRandomnessSnapshot {
                    packing_factor: 4,
                    total_fixed_candidate_slot_count: 1_211_008,
                    total_uniform_message_byte_length: 10_555_392,
                    concrete_challenge_stream_hash_query_count: 165_006,
                    field_sampling_exhaustion_security_bit_floor_per_attempt: 4_088,
                },
                UniformRandomnessSnapshot {
                    packing_factor: 8,
                    total_fixed_candidate_slot_count: 1_218_176,
                    total_uniform_message_byte_length: 10_598_400,
                    concrete_challenge_stream_hash_query_count: 165_676,
                    field_sampling_exhaustion_security_bit_floor_per_attempt: 4_088,
                },
            ]
        );
