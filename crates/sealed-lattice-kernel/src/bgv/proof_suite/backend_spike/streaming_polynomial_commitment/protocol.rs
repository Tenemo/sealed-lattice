...
use super::{ChallengeField, GOLDILOCKS_MODULUS};
...
pub(super) const MAXIMUM_STREAMING_WIRE_BYTE_LENGTH: usize = 5_242_880;
...
#[derive(Clone)]
pub(super) struct AuthenticatedColumn {
    pub(super) column_index: usize,
    pub(super) values: Vec<Goldilocks>,
}
