...
use super::compact_whir::{
    COMPACT_WHIR_FINAL_VARIABLE_COUNT, COMPACT_WHIR_FOLD_COUNT, COMPACT_WHIR_MASK_LOG_INVERSE_RATE,
    COMPACT_WHIR_PROTOCOL_SECURITY_LEVEL, COMPACT_WHIR_REPEATED_FOLDING_FACTOR,
    COMPACT_WHIR_ROUND_COUNT, COMPACT_WHIR_ROUND_LOG_INVERSE_RATES,
    COMPACT_WHIR_STARTING_LOG_INVERSE_RATE, COMPACT_WHIR_SUMCHECK_MASK_MESSAGE_LENGTH,
};
