...
pub(crate) use compact_ring_vector::{
    CompactLookupRelationGeometry, CompactStructuredWitnessCovectorAccumulator,
    CompactStructuredWitnessCovectorAccumulatorPoll, StructuredTransposeValueSource,
