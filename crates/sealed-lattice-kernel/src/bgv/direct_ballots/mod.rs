...
pub(crate) use request::{
    ...
    PairCharacterEncoderProfileTerm, PairCharacterPlaintext, SCORE_BUCKET_COUNT,
    pair_character_encoder_profile_sequence, pair_character_encoder_profile_terms,
    pair_character_lane_idempotent_coefficients, pair_character_lane_value,
    pair_character_plaintexts, selected_pair_character_lane_assignments,
};
