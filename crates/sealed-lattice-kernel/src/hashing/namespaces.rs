...
reserved_root_namespaces! {
    ...
    SUCCINCT_EVALUATION_KEY_PROOF_ACCOUNTING_HASH_NAMESPACE => "sealed-lattice-root/succinct-evaluation-key-proof-accounting-hash-v1",
    SUCCINCT_SAME_SECRET_LINKAGE_ANCHOR_ACCOUNTING_HASH_NAMESPACE => "sealed-lattice-root/succinct-same-secret-linkage-anchor-accounting-hash-v1",
    SUCCINCT_PUBLIC_KEY_SHARE_ACCOUNTING_HASH_NAMESPACE => "sealed-lattice-root/succinct-public-key-share-accounting-hash-v1",
    SUCCINCT_PRIVATE_VSS_SHARE_ACCOUNTING_HASH_NAMESPACE => "sealed-lattice-root/succinct-private-vss-share-accounting-hash-v1",
    ...
    COLLECTIVE_BGV_SETUP_THRESHOLD_PROFILE_HASH_NAMESPACE => "sealed-lattice-root/collective-bgv-setup-threshold-profile-hash-v1",
    ...
    SETUP_ASSEMBLY_PROVENANCE_CERTIFICATE_HASH_NAMESPACE => "sealed-lattice-root/setup-assembly-provenance-certificate-hash-v1",
    ...
    PRIVATE_VSS_SHARE_PROOF_RANDOMNESS_NAMESPACE => "sealed-lattice-root/private-vss-share-proof-randomness-v1",
    ...
    SAME_SECRET_LINKAGE_ANCHOR_PROOF_MATERIAL_ROOT_NAMESPACE => "sealed-lattice-root/same-secret-linkage-anchor-proof-material-root-v1",
    LOCAL_TRUSTEE_SETUP_STATE_ROOT_NAMESPACE => "sealed-lattice-root/local-trustee-setup-state-root-v1",
    LOCAL_TRUSTEE_SETUP_STATE_TRANSPORT_EVIDENCE_ROOT_NAMESPACE => "sealed-lattice-root/local-trustee-setup-state-transport-evidence-root-v1",
    ...
    SETUP_PHASE_TRANSCRIPT_ROOT_NAMESPACE => "sealed-lattice-root/setup-phase-transcript-root-v1",
    ...
    TRUSTEE_EVALUATION_KEY_PROOF_ROOT_NAMESPACE => "sealed-lattice-root/trustee-evaluation-key-proof-root-v1",
    TRUSTEE_EVALUATION_KEY_PROOF_SET_ROOT_NAMESPACE => "sealed-lattice-root/trustee-evaluation-key-proof-set-root-v1",
    TRUSTEE_EVALUATION_KEY_PROOF_MATERIAL_ROOT_NAMESPACE => "sealed-lattice-root/trustee-evaluation-key-proof-material-root-v1",
    TRUSTEE_EVALUATION_KEY_PROOF_RANDOMNESS_NAMESPACE => "sealed-lattice-root/trustee-evaluation-key-proof-randomness-v1",
    ...
    DIRECT_BALLOT_RESERVED_SLOT_RULE_HASH_NAMESPACE => "sealed-lattice-root/direct-ballot-reserved-slot-rule-hash-v1",
    DIRECT_BALLOT_ENCODER_MATRIX_ROOT_NAMESPACE => "sealed-lattice-root/direct-ballot-encoder-matrix-root-v1",
    DIRECT_BALLOT_WITNESS_PARTITION_PROFILE_HASH_NAMESPACE => "sealed-lattice-root/direct-ballot-witness-partition-profile-hash-v1",
    BALLOT_PROOF_ARITHMETIC_CERTIFICATE_HASH_NAMESPACE => "sealed-lattice-root/ballot-proof-arithmetic-certificate-hash-v1",
    BALLOT_PROOF_SOUNDNESS_CERTIFICATE_HASH_NAMESPACE => "sealed-lattice-root/ballot-proof-soundness-certificate-hash-v1",
    BALLOT_PROOF_ZERO_KNOWLEDGE_CERTIFICATE_HASH_NAMESPACE => "sealed-lattice-root/ballot-proof-zero-knowledge-certificate-hash-v1",
    BALLOT_PROOF_VERIFIER_CERTIFICATE_HASH_NAMESPACE => "sealed-lattice-root/ballot-proof-verifier-certificate-hash-v1",
    BALLOT_VALIDITY_STATEMENT_HASH_NAMESPACE => "sealed-lattice-root/ballot-validity-statement-hash-v1",
    BALLOT_PROOF_CHUNK_MANIFEST_ROOT_NAMESPACE => "sealed-lattice-root/ballot-proof-chunk-manifest-root-v1",
    ENCRYPTED_BALLOT_PACKAGE_ROOT_NAMESPACE => "sealed-lattice-root/encrypted-ballot-package-root-v1",
    DIRECT_ENCRYPTED_BALLOT_PACKAGE_VERIFICATION_CERTIFICATE_HASH_NAMESPACE => "sealed-lattice-root/direct-encrypted-ballot-package-verification-certificate-hash-v1",
    DIRECT_ENCRYPTED_BALLOT_AGGREGATE_CERTIFICATE_HASH_NAMESPACE => "sealed-lattice-root/direct-encrypted-ballot-aggregate-certificate-hash-v1",
    DIRECT_ENCRYPTED_BALLOT_CREATION_POLICY_HASH_NAMESPACE => "sealed-lattice-root/direct-encrypted-ballot-creation-policy-hash-v1",
