...
reserved_root_namespaces! {
    ...
    SUCCINCT_TARGET_DECRYPTION_SHARE_ACCOUNTING_HASH_NAMESPACE => "sealed-lattice-root/succinct-target-decryption-share-accounting-hash-v1",
    ...
    COMPACT_VSS_PARAMETER_CERTIFICATE_INPUT_BINDING_HASH_NAMESPACE => "sealed-lattice-root/compact-vss-parameter-certificate-input-binding-hash-v1",
    COMPACT_VSS_MATRIX_EXPANSION_PROFILE_HASH_NAMESPACE => "sealed-lattice-root/compact-vss-matrix-expansion-profile-hash-v1",
    ...
    TARGET_DECRYPTION_SHARE_PROOF_MATERIAL_ROOT_NAMESPACE => "sealed-lattice-root/target-decryption-share-proof-material-root-v1",
    ...
    TARGET_DECRYPTION_SMUDGING_COMMITMENT_SET_ROOT_NAMESPACE => "sealed-lattice-root/target-decryption-smudging-commitment-set-root-v1",
