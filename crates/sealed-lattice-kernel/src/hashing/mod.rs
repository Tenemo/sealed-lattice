...
reserved_root_namespaces! {
    ...
    RANK_PACKING_HASH_NAMESPACE => "sealed-lattice-root/rank-packing-hash-v1",
    ...
    ALGEBRAIC_THRESHOLD_SHARE_VERIFICATION_KEY_ROOT_NAMESPACE => "sealed-lattice-root/algebraic-threshold-share-verification-key-root-v1",
    ALGEBRAIC_THRESHOLD_SHARE_VERIFICATION_KEY_HASH_NAMESPACE => "sealed-lattice-root/algebraic-threshold-share-verification-key-hash-v1",
    TRUSTEE_PUBLIC_KEY_SHARE_COEFFICIENT_MATERIAL_ROOT_NAMESPACE => "sealed-lattice-root/trustee-public-key-share-coefficient-material-root-v1",
    TRUSTEE_PUBLIC_KEY_SHARE_COEFFICIENT_MATERIAL_HASH_NAMESPACE => "sealed-lattice-root/trustee-public-key-share-coefficient-material-hash-v1",
    ...
    MASKED_RANK_REFRESH_PROFILE_HASH_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-profile-hash-v1",
    MASKED_RANK_REFRESH_TRANSCRIPT_ROOT_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-transcript-root-v1",
    MASKED_RANK_REFRESH_SHARE_SELECTION_RULE_HASH_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-share-selection-rule-hash-v1",
    MASKED_RANK_REFRESH_SELECTED_ALGEBRAIC_SHARE_VERIFICATION_KEY_BINDING_ROOT_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-selected-algebraic-share-verification-key-binding-root-v1",
    MASKED_RANK_REFRESH_INPUT_RANK_CIPHERTEXT_COMPONENT_ONE_PAYLOAD_HASH_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-input-rank-ciphertext-component-one-payload-hash-v1",
    MASKED_RANK_REFRESH_PARTIAL_DECRYPTION_SHARE_ROOT_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-partial-decryption-share-root-v1",
    MASKED_RANK_REFRESH_PART_DEC_LINEAR_RELATION_STATEMENT_ROOT_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-part-dec-linear-relation-statement-root-v1",
    MASKED_RANK_REFRESH_PART_DEC_LINEAR_PROOF_BACKEND_ADAPTER_ROOT_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-part-dec-linear-proof-backend-adapter-root-v1",
    MASKED_RANK_REFRESH_PART_DEC_LINEAR_PROOF_BACKEND_INPUT_ROOT_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-part-dec-linear-proof-backend-input-root-v1",
    MASKED_RANK_REFRESH_PART_DEC_PUBLIC_KEY_SHARE_CONSISTENCY_LINEAR_PROOF_BACKEND_INPUT_ROOT_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-part-dec-public-key-share-consistency-linear-proof-backend-input-root-v1",
    MASKED_RANK_REFRESH_PART_DEC_MASKED_SHARE_LINEAR_PROOF_BACKEND_INPUT_ROOT_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-part-dec-masked-share-linear-proof-backend-input-root-v1",
    MASKED_RANK_REFRESH_PART_DEC_SPLIT_SAME_WITNESS_BINDING_ROOT_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-part-dec-split-same-witness-binding-root-v1",
    MASKED_RANK_REFRESH_PART_DEC_SHARE_EQUATION_PROOF_ROOT_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-part-dec-share-equation-proof-root-v1",
    MASKED_RANK_REFRESH_PART_DEC_SHARE_EQUATION_PROOF_STATEMENT_HASH_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-part-dec-share-equation-proof-statement-hash-v1",
    MASKED_RANK_REFRESH_SMUDGING_BOUND_CERTIFICATE_HASH_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-smudging-bound-certificate-hash-v1",
    MASKED_RANK_REFRESH_SMUDGING_BOUND_STATEMENT_HASH_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-smudging-bound-statement-hash-v1",
    MASKED_RANK_REFRESH_FIN_DEC_LAGRANGE_COEFFICIENT_AUDIT_ROOT_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-fin-dec-lagrange-coefficient-audit-root-v1",
    MASKED_RANK_REFRESH_FIN_DEC_MASKED_OPENING_ROOT_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-fin-dec-masked-opening-root-v1",
    MASKED_RANK_REFRESH_FIN_DEC_MASKED_OPENING_PAYLOAD_ROOT_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-fin-dec-masked-opening-payload-root-v1",
    MASKED_RANK_REFRESH_FIN_DEC_MASKED_OPENING_STATEMENT_HASH_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-fin-dec-masked-opening-statement-hash-v1",
    MASKED_RANK_REFRESH_MASK_COMMITMENT_ROOT_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-mask-commitment-root-v1",
    MASKED_RANK_REFRESH_MASK_ENCRYPTION_RANDOMNESS_EVIDENCE_HASH_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-mask-encryption-randomness-evidence-hash-v1",
    MASKED_RANK_REFRESH_ENCRYPTED_MASK_CIPHERTEXT_PAYLOAD_HASH_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-encrypted-mask-ciphertext-payload-hash-v1",
    MASKED_RANK_REFRESH_REFRESHED_RANK_CIPHERTEXT_PAYLOAD_HASH_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-refreshed-rank-ciphertext-payload-hash-v1",
    MASKED_RANK_REFRESH_MASK_RE_ENCRYPTION_PROOF_ROOT_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-mask-re-encryption-proof-root-v1",
    MASKED_RANK_REFRESH_MASK_RE_ENCRYPTION_PROOF_STATEMENT_HASH_NAMESPACE => "sealed-lattice-root/masked-rank-refresh-mask-re-encryption-proof-statement-hash-v1",
    ENCRYPTED_RANK_ACCUMULATION_HASH_NAMESPACE => "sealed-lattice-root/encrypted-rank-accumulation-hash-v1",
    TOP_K_CIPHERTEXT_HASH_NAMESPACE => "sealed-lattice-root/top-k-ciphertext-hash-v1",
    TARGET_CIPHERTEXT_HASH_NAMESPACE => "sealed-lattice-root/target-ciphertext-hash-v1",
    ...
    EVALUATION_NOISE_CERT_HASH_NAMESPACE => "sealed-lattice-root/evaluation-noise-cert-hash-v1",
    ...
    OUTPUT_ENCODING_HASH_NAMESPACE => "sealed-lattice-root/output-encoding-hash-v1",
    TIE_POLICY_HASH_NAMESPACE => "sealed-lattice-root/tie-policy-hash-v1",
    EVALUATION_PARAMETER_HASH_NAMESPACE => "sealed-lattice-root/evaluation-parameter-hash-v1",
    EVALUATOR_INPUT_STATEMENT_HASH_NAMESPACE => "sealed-lattice-root/evaluator-input-statement-hash-v1",
    ENCRYPTED_SCORE_BIT_OUTPUT_HASH_NAMESPACE => "sealed-lattice-root/encrypted-score-bit-output-hash-v1",
