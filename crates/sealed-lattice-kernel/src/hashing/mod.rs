...
pub const DIRECT_Q_DATA_BRIDGE_PROFILE_DIGEST_NAMESPACE: &str =
    "sealed-lattice-root/direct-q-data-bridge-profile-digest-v1";
...
pub const APPENDIX_D_PROFILE_DIGEST_NAMESPACE: &str =
    "sealed-lattice-root/appendix-d-profile-digest-v1";
...
pub const RESERVED_ROOT_NAMESPACES: &[&str] = &[
    ...
    DIRECT_Q_DATA_BRIDGE_PROFILE_DIGEST_NAMESPACE,
    ...
    APPENDIX_D_PROFILE_DIGEST_NAMESPACE,
...
mod tests {
    ...
    use super::{
        ...
        AGGREGATE_DERIVATION_COMPONENT_DIGEST_NAMESPACE, AGGREGATE_READY_RECORD_DIGEST_NAMESPACE,
        AGGREGATE_SELECTION_POLICY_DIGEST_NAMESPACE, AGGREGATE_SHARE_COMMITMENT_DIGEST_NAMESPACE,
        ALLOWED_EVALUATOR_OPS_DIGEST_NAMESPACE, APPENDIX_D_PROFILE_DIGEST_NAMESPACE,
        BALLOT_PACKAGE_DIGEST_NAMESPACE, BALLOT_SET_DIGEST_NAMESPACE,
        ...
        CAST_RECEIPT_DIGEST_NAMESPACE, CIPHERTEXT_ROOT_NAMESPACE, CLOSE_RECORD_DIGEST_NAMESPACE,
        ...
        DIRECT_Q_DATA_BRIDGE_PROFILE_DIGEST_NAMESPACE, DUPLICATE_BALLOT_POLICY_DIGEST_NAMESPACE,
        ELECTION_MANIFEST_DIGEST_NAMESPACE, ENCRYPTED_ENVELOPE_ROOT_NAMESPACE,
        EVAL_KEY_ROOT_NAMESPACE, EVALUATION_CONTEXT_DIGEST_NAMESPACE,
        EVALUATION_PROOF_PROFILE_DIGEST_NAMESPACE, EVALUATION_PROOF_RECORD_DIGEST_NAMESPACE,
        FIRST_VALID_ORDER_DIGEST_NAMESPACE, FIRST_VALID_POLICY_DIGEST_NAMESPACE,
        HE_EVALUATION_NOISE_CERT_DIGEST_NAMESPACE, HE_PARAM_DIGEST_NAMESPACE,
        INCLUSION_PROOF_DIGEST_NAMESPACE, LOCAL_REPLAY_RECORD_DIGEST_NAMESPACE,
        MOBILE_PROFILE_CERT_DIGEST_NAMESPACE, MOBILE_REPLAY_CERT_DIGEST_NAMESPACE,
        PLAINTEXT_ROOT_NAMESPACE, POLL_SPEC_DIGEST_NAMESPACE,
        POST_VOTING_CLOSED_CONTEXT_DIGEST_NAMESPACE, PROTOCOL_SIGNATURE_ENVELOPE_DIGEST_NAMESPACE,
        PROVIDER_BUILD_DIGEST_NAMESPACE, PUBLIC_KEY_DIGEST_NAMESPACE,
        PUBLIC_SLOT_MASK_DIGEST_NAMESPACE, Q_TARGET_DIGEST_NAMESPACE,
        RECEIVER_KEY_REGISTRATION_DIGEST_NAMESPACE, RECOVERY_EPOCH_UPDATE_DIGEST_NAMESPACE,
        RECOVERY_POLICY_DIGEST_NAMESPACE, REGISTRATION_ENTRY_DIGEST_NAMESPACE,
        RESERVED_ROOT_NAMESPACES, ROSTER_DIGEST_NAMESPACE,
        ROSTER_EXTERNAL_ACCEPTANCE_DIGEST_NAMESPACE, ROT_SET_DIGEST_NAMESPACE,
        SHARE_COMMITMENT_DIGEST_NAMESPACE, SIGNED_ROOT_DIGEST_NAMESPACE,
        TARGET_ACCEPTED_RECORD_DIGEST_NAMESPACE, TARGET_CONTEXT_DIGEST_NAMESPACE,
        TARGET_DECRYPTION_CIPHERTEXT_DIGEST_NAMESPACE,
        TARGET_DECRYPTION_PREPARATION_RECORD_DIGEST_NAMESPACE,
        ...
        TRUSTEE_SETUP_ENTRY_DIGEST_NAMESPACE, VERIFIED_TOP_K_RESULT_DIGEST_NAMESPACE,
        WITNESS_CHECKPOINT_DIGEST_NAMESPACE, WITNESS_EQUIVOCATION_EVIDENCE_DIGEST_NAMESPACE,
        WITNESS_POLICY_DIGEST_NAMESPACE, canonical_root, chunk_root, hash512, hash512_hex,
        namespace_root,
    };
    ...
    #[test]
    fn reserved_root_namespaces_cover_v53_bgv_foundation() {
        let namespace_set: BTreeSet<&str> = RESERVED_ROOT_NAMESPACES.iter().copied().collect();
