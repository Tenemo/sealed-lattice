...
mod tests {
    ...
    use super::{
        ...
        LOCAL_REPLAY_RECORD_DIGEST_NAMESPACE, MOBILE_PROFILE_CERT_DIGEST_NAMESPACE,
        MOBILE_REPLAY_CERT_DIGEST_NAMESPACE, PLAINTEXT_ROOT_NAMESPACE, POLL_SPEC_DIGEST_NAMESPACE,
        ...
        SHARE_COMMITMENT_DIGEST_NAMESPACE, SHARE_REPLAY_EVIDENCE_DIGEST_NAMESPACE,
        ...
        canonical_root, chunk_root, hash512, hash512_hex, namespace_root,
    };
