...
reserved_root_namespaces! {
    ...
    SCORE_BIT_AGGREGATION_RELATION_DIGEST_NAMESPACE => "sealed-lattice-root/score-bit-aggregation-relation-digest-v1",
    ENCRYPTED_SCORE_BIT_INPUT_LAYOUT_DIGEST_NAMESPACE => "sealed-lattice-root/encrypted-score-bit-input-layout-digest-v1",
