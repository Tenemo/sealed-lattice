...
pub const FIRST_COME_ORDER_DIGEST_NAMESPACE: &str =
    "sealed-lattice-root/first-come-order-digest-v1";
pub const DUPLICATE_BALLOT_POLICY_DIGEST_NAMESPACE: &str =
    "sealed-lattice-root/duplicate-ballot-policy-digest-v1";
pub const FIRST_COME_POLICY_DIGEST_NAMESPACE: &str =
    "sealed-lattice-root/first-come-policy-digest-v1";
...
pub const RESERVED_ROOT_NAMESPACES: &[&str] = &[
    ...
    FIRST_COME_ORDER_DIGEST_NAMESPACE,
    DUPLICATE_BALLOT_POLICY_DIGEST_NAMESPACE,
    FIRST_COME_POLICY_DIGEST_NAMESPACE,
...
mod tests {
    ...
    use super::{
        ...
        BOARD_ENTRY_DIGEST_NAMESPACE, BOARD_HEAD_DIGEST_NAMESPACE, BOARD_POLICY_DIGEST_NAMESPACE,
        BOARD_ROOT_DIGEST_NAMESPACE, BRAKERSKI_DELTA_DIGEST_NAMESPACE,
        ...
        CONFLICTING_HEAD_EVIDENCE_DIGEST_NAMESPACE, CPAD_PROFILE_DIGEST_NAMESPACE,
        DERIVED_AGGREGATE_CIPHERTEXT_ROOT_NAMESPACE, DUPLICATE_BALLOT_POLICY_DIGEST_NAMESPACE,
        ...
        EVALUATION_PROOF_ROOT_NAMESPACE, EVALUATION_REPLAY_ATTESTATION_DIGEST_NAMESPACE,
        FIRST_COME_ORDER_DIGEST_NAMESPACE, FIRST_COME_POLICY_DIGEST_NAMESPACE,
        ...
        PROOF_PRIME_TO_Q_DATA_KEY_CONSISTENCY_DIGEST_NAMESPACE,
        PROTOCOL_SIGNATURE_ENVELOPE_DIGEST_NAMESPACE, PROVIDER_BUILD_DIGEST_NAMESPACE,
        PUBLIC_KEY_DIGEST_NAMESPACE, PUBLIC_SLOT_MASK_DIGEST_NAMESPACE, Q_TARGET_DIGEST_NAMESPACE,
        ...
        RESERVED_ROOT_NAMESPACES, ROSTER_DIGEST_NAMESPACE, ROT_SET_DIGEST_NAMESPACE,
        SHARE_COMMITMENT_DIGEST_NAMESPACE, SIGNED_ROOT_DIGEST_NAMESPACE,
        TARGET_ACCEPTED_RECORD_DIGEST_NAMESPACE,
        TARGET_DECRYPTION_PREPARATION_RECORD_DIGEST_NAMESPACE,
        TARGET_FINALITY_POLICY_DIGEST_NAMESPACE, TARGET_FINALITY_RECORD_DIGEST_NAMESPACE,
        TARGET_LAYOUT_DIGEST_NAMESPACE, TARGET_PREIMAGE_DIGEST_NAMESPACE,
    ...
    #[test]
    fn reserved_root_namespaces_cover_v46_1_election_foundation() {
        let namespace_set: BTreeSet<&str> = RESERVED_ROOT_NAMESPACES.iter().copied().collect();
