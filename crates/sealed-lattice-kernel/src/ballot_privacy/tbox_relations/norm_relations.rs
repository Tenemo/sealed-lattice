...
pub(super) fn validate_linear_proof_tbox_shape() -> CanonicalResult<()> {
...
pub(super) fn linear_proof_tbox_short_message_without_upsilon() -> usize {
...
#[cfg(test)]
pub(super) fn linear_proof_tbox_upsilon_offset() -> usize {
