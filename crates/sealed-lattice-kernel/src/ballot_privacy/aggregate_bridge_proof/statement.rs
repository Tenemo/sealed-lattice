...
pub(super) fn build_bridge_proof_statement(
    ...
    let relation_requirements = json!({
        ...
        "sharedWitnessAdditionalRelationLossBits": BRIDGE_ADDITIONAL_RELATION_LOSS_BITS,
        "sharedWitnessBgvSupportRelation": BRIDGE_BGV_SUPPORT_RELATION,
        "sharedWitnessBgvSupportChallengeDistribution": BRIDGE_BGV_SUPPORT_CHALLENGE_DISTRIBUTION,
        "sharedWitnessBgvSupportCancellationModel": BRIDGE_BGV_SUPPORT_CANCELLATION_MODEL,
        "sharedWitnessBgvSupportUnionBoundBits": BRIDGE_BGV_SUPPORT_UNION_BOUND_BITS,
