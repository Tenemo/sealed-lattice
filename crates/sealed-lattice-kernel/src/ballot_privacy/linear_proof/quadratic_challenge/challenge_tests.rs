...
mod tests {
    ...
    use crate::{
        ballot_privacy::linear_proof::{
            ...
            parameters::{demo_linear_proof_encoding_contract, linear_proof_profile_for_encoding},
            profile_constants::DEMO_GENERATED_PROFILE,
    ...
    fn valid_generated_proof_recomputes_quadratic_challenge() {
        ...
        let tbox_summary =
            validate_tbox_public_checks(&abdlop_commitment_hash, &decoded_proof, &proof_encoding)
