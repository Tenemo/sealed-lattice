...
#[cfg(test)]
mod tests {
    use super::validate_norms;
    use crate::{
        ballot_privacy::linear_proof::{
            parameters::LinearProofEncoding, profile_constants::DEMO_GENERATED_PROFILE,
    ...
    fn generated_valid_proof_passes_demo_norm_checks() {
        ...
        let summary = validate_norms(&decoded_proof, &proof_encoding)
    ...
    fn euclidean_response_bound_failure_is_reported() {
        ...
        let error = validate_norms(&decoded_proof, &proof_encoding)
