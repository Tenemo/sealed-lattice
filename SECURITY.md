...
| `SEC-004` | The selected common-proof replacement is not production-integrated, and its exact extraction, binding, transcript, and quantum-random-oracle soundness arguments are incomplete. | A passing development proof does not establish the intended proof-system assurance.                        |
