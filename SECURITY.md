...
- `SEC-024`: The rejected experiment has a production-object static ledger and a complete development-Chromium ceremony, including transfer, refetch, checkpoint, protected-record, worker-copy, WebAssembly-memory, scalar-work, visit, and foreground measurements. Those values describe rejected bytes and cannot be applied mechanically to a replacement. Production resources, external release-Chrome behavior, and selected-phone feasibility are open.
