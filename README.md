...
| Common proof replacement    | Independent relation, matrix, source, and witness checks plus one exact native public-key-share proof candidate; a separately constructed equation-invalid proof is refused and cannot mint a capability | The candidate is not selected; its complete hostile corpus, theorem and privacy composition, release WebAssembly path, browser lifecycle, and eleven remaining proof families are open         |
