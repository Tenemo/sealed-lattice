...
- The organizer may close voting without waiting for every participant. Closing must create one verifiable inventory of all accepted pre-close ballots.
...
The host application remains responsible for registration, invitations, notifications, and the user interface. Participants confirm the frozen public roster. Real-world identity verification, duplicate-person prevention, coercion resistance, and endpoint security are outside this library.
