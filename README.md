...
- the setup package verifier intentionally remains claim-pending until same-secret and public-key external AB-DLOP/LNP soundness and zero-knowledge review, full tbox quadratic/range proof closure, relinearization proofs, and Galois proofs are complete.
