...
The version-one operation-fresh padded transcript with 320-bit operation keys remains a functional full-tally vertical, but its former admitted identity `dfee7cd92b199269c24f2c87db2e6d021a721345e9b0274c53edcfb45632f1b5cfd4e41be5850eb68ec9f7b9e3f3b63aa74bb5299fb5e4dfd1f436613eba1382` is withdrawn. Those bytes use a finality quorum derived from an excluded complete-profile-rollback premise, allow all-abstain no result without every participant's required postfinality action, and lack an absorbing durable local-retirement state. The repaired protocol requires seven-of-ten direct finality, ten target-bound postfinality acknowledgements before an all-abstain terminal, and fail-closed local retirement after attributable misconduct or detected partial state loss. Production dispatch remains disabled while the new bytes, theorem mapping, hostile review, and runtime evidence are rebuilt.
