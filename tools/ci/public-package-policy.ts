...
export const forbiddenTypeExports = [
    ...
    'BgvTargetDecryptionShareProofLayoutLimb',
    'BgvTargetDecryptionShareProofLayoutMessage',
...
export const vendoredProtocolRuntimeModules = [
    ...
    'setup/setup-certificates/profile-derivations.ts',
    'setup/setup-certificates/commitment-security-certificate.ts',
    'setup/setup-certificates/proof-accounting-certificate.ts',
    'setup/setup-certificates/transport-certificate.ts',
    'setup/setup-certificates/he-security-certificate.ts',
