//! Canonical plain-WHIR proof types.
//!
//! Local modification: the unused round proof-of-work getter was removed; the
//! resumable verifier consumes each round directly. See `../../UPSTREAM.md`.
