...
A passing vector proves only its named test property. No retained vector is an accepted proof, suite-activation record, current security certificate, production-authority capability, or supported-phone result.
...
- Keep obsolete backend vectors deleted. Historical records cannot become a fallback evidence authority.
...
- Keep exact runtime and proof evidence in the owning run diagnostics rather than copying measurements into fixture documentation.
