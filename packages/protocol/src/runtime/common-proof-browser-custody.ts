...
const canonicalOutputKeyDomain =
...
type CanonicalOutputChunk = Readonly<{
    byteLength: number;
    logicalRecordKey: string;
}>;
...
const isSafeUnsigned32 = (value: number): boolean =>
    Number.isSafeInteger(value) && value >= 0 && value <= maximumUnsigned32;

const isNonEmptyByteArrayList = (
    value: unknown,
...
const copyCheckpointResumeDescriptor = (
...
const destroyCheckpointResumeDescriptor = (
...
const destroyExternalMemoryObjectInMemory = (
    object: ExternalMemoryObjectState,
): void => {
...
const checkpointEnvironmentBindingHash = (input: {
    commonProofEnvironmentIdentifier: Uint8Array;
    commonProofRuntimeBindingHash: Uint8Array;
    proofAttemptLineageIdentifier: Uint8Array;
}): Uint8Array<ArrayBuffer> => {
