...
export class UntrustedStorageTransactionStore {
    ...
    readonly #authenticatedRepair: AuthenticatedRepairRuntime;
    readonly #storageInstanceIdentity: Uint8Array;
    ...
    public constructor(
        ...
        this.#authenticatedRepair = createAuthenticatedRepairRuntime(
            configuration.authenticatedRepairProtection,
        );
        this.#storageInstanceIdentity =
            this.#authenticatedRepair.protection.repairIdentity.slice();
    }
    ...
    ): Promise<AuthenticatedRepairPublication> {
        const repair = this.#authenticatedRepair;
        await this.#assertAuthenticatedRepairHeadUnchanged();
    ...
    async #commitTransaction(transaction: TransactionRecord): Promise<void> {
        ...
        let authenticatedRepairPublication: AuthenticatedRepairPublication;
        try {
