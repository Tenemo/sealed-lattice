...
import { openDurableStateWitnessServiceWithProtection } from '../durable-state-witness-service.js';
import {
...
import {
    ...
    encodeFoundationWitnessRuntimeRecordEnvelope,
    ...
    openFoundationWitnessProtectedEnvelope,
    assertNamespace,
    deriveWebLockStorageNamespaceName,
    normalizeError,
    type WebLockOwnedStorageState,
    type WebLockOwnedStorageTransactionStore,
    type TransferableWebLockOwnedStorageTransactionStore,
    type WebLockOwnedStorageBaseConfiguration,
    ...
    type Deferred,
    type OpenedFoundationWitnessRuntimeRecordEnvelope,
} from './records.js';
import {
    ...
    openRuntimeRecordProtectedPlaintext,
