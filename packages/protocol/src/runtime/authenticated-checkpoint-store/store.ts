...
import {
    ...
    deriveCheckpointManifestDigest,
...
> => {
    ...
    const checkpointChunkStoredValueByteLength =
        ...
        maximumChunkCount *
            BigInt(runtimeRecordEnvelopeOverheadByteLength) *
            2n;
...
export const openAuthenticatedCheckpointStoreWithProtection = (input: {
    ...
    const destroyBoundary = (
        ...
        boundary.deterministicCursorBytes.fill(0);
        boundary.randomnessAuthorityIdentifier?.fill(0);
    };
    ...
    const destroyOperationIdentityRecord = (
        ...
        identityRecord.randomnessAuthorityIdentifier?.fill(0);
        identityRecord.randomnessAuthorityIdentifier = undefined;
    };
    ...
    const createOperationIdentity = (
        checkpointLineageIdentifier: Uint8Array,
        randomnessAuthorityIdentifier: Uint8Array | undefined,
        ...
        const attemptIdentifier = randomnessAuthorityIdentifier?.slice();
        const identity = Object.freeze({
            ...
            get randomnessAuthorityIdentifier(): Uint8Array | undefined {
        ...
        const identityRecord: CheckpointOperationIdentityRecord = {
            ...
            ...(attemptIdentifier === undefined
                ? {}
                : {
                      randomnessAuthorityIdentifier: attemptIdentifier,
                  }),
        };
    ...
    const requireMonotonicPublicationBoundary = (
        ...
        if (identityRecord.operationKind === undefined) {
            ...
            identityRecord.randomnessAuthorityIdentifier =
                boundary.randomnessAuthorityIdentifier?.slice();
        } else if (
            identityRecord.operationKind !== boundary.operationKind ||
            identityRecord.stateStreamDomain !== boundary.stateStreamDomain ||
            (identityRecord.randomnessAuthorityIdentifier === undefined) !==
        ...
        // The store binds opaque cursor bytes exactly. Their operation-specific
        // meaning remains the boundary policy's responsibility.
    };
    ...
    const beginOperation: AuthenticatedCheckpointStore['beginOperation'] =
        async (untrustedRandomnessAuthorityIdentifier) => {
            let randomnessAuthorityIdentifier: Uint8Array | undefined;
            ...
            try {
                randomnessAuthorityIdentifier =
                    untrustedRandomnessAuthorityIdentifier === undefined
                        ? undefined
                        : copyExactBytes(
                              untrustedRandomnessAuthorityIdentifier,
                              identifierByteLength,
                              'randomnessAuthorityIdentifier',
                          );
                ...
                randomnessAuthorityIdentifier?.fill(0);
    ...
    const publishUnlocked: AuthenticatedCheckpointStore['publish'] = async ({
        ...
        if (
            (issuedIdentity.randomnessAuthorityIdentifier === undefined) !==
                (boundary.randomnessAuthorityIdentifier === undefined) ||
            (issuedIdentity.randomnessAuthorityIdentifier !== undefined &&
                boundary.randomnessAuthorityIdentifier !== undefined &&
                !bytesEqual(
                    issuedIdentity.randomnessAuthorityIdentifier,
                    boundary.randomnessAuthorityIdentifier,
                ))
        ) {
            throw new AuthenticatedRuntimeRecordError(
                'InvalidInput',
                'Checkpoint deterministic-cursor attempt was not issued for this operation.',
            );
        }
        ...
        const repeatedBoundary =
            previousManifest !== undefined &&
            issuedIdentity.lastPublishedBoundary?.safeBoundaryOrdinal ===
                boundary.safeBoundaryOrdinal;
        const checkpointGeneration =
            previousManifest === undefined
                ? 1n
                : repeatedBoundary
                  ? previousManifest.record.checkpointGeneration
                  : previousManifest.record.checkpointGeneration + 1n;
        if (checkpointGeneration > 0xffff_ffff_ffff_ffffn) {
            throw new AuthenticatedRuntimeRecordError(
                'ResourceLimit',
        ...
        const previousCheckpointDigest =
            previousManifest === undefined
                ? new Uint8Array(64)
                : repeatedBoundary
                  ? previousManifest.record.previousCheckpointDigest.slice()
                  : deriveCheckpointManifestDigest(
                        previousManifest.record.canonicalManifestBytes,
                    );
        ...
        previousCheckpointDigest.fill(0);
        if (
        ...
        const journalPlaintext = encodeStoredJournal(journalRecord, limits);
    ...
    const resumeUnlocked: AuthenticatedCheckpointStore['resume'] = async ({
        ...
        const expectedCanonicalManifest = encodeCheckpointManifest({
            ...
            checkpointGeneration: manifest.record.checkpointGeneration,
            checkpointLineageIdentifier: lineageIdentifier,
            previousCheckpointDigest: manifest.record.previousCheckpointDigest,
        ...
        return Object.freeze({
            ...
            operationIdentity: createOperationIdentity(
                lineageIdentifier,
                expectedBoundary.randomnessAuthorityIdentifier,
                false,
                {
                    boundary: {
                        ...expectedBoundary,
    ...
    const createOwnedStore = (
        ...
        Object.freeze({
            beginOperation: (randomnessAuthorityIdentifier) =>
                lifecycle.run(owner, () =>
                    beginOperation(randomnessAuthorityIdentifier),
                ),
...
/** Convenience constructor for a caller-owned nonextractable encryption key. */
