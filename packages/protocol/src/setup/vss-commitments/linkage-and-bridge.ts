...
type VssSameSecretBridgeTargetConstantRoot = {
...
type VssSameSecretBridgeTargetConstantCommitment = {
    readonly rnsLimbIndex: number;
    readonly rnsPrime: number;
    readonly shamirCoefficientIndex: number;
...
// The same-secret bridge relation binds each trustee's public constant
// commitments to the canonical source VSS commitment set across all Q_share
// limbs using one signed ternary secret.
