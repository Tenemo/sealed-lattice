...
This package contains deterministic protocol-development helpers for transcript rules, canonical selection, poll validation, structural threshold-count calculation, roster and manifest checks, namespace freshness, setup artifact construction, and browser-local durable-state coordination.
