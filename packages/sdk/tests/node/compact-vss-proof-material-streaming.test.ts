...
type CompactProofMaterialCase = Readonly<{
...
const sameSecretBridgeIdentityFields = (recordIndex: number): JsonRecord => ({
    compactSameSecretBridgeStatementRoot: `${String(recordIndex)}`.padStart(
        128,
        'c',
    ),
});

const compactProofMaterialCases = [
    {
        proofFamily: 'compact-vss-share-linkage',
        proofRecordObjectType: 'CompactVssShareLinkageProofRecord',
        proofMaterialSetObjectType: 'CompactVssShareLinkageProofMaterialSet',
        ...
        moveEmbeddedToTransport: (proofMaterialSet: JsonRecord) => {
            ...
            return {
                ...
                transportedProofMaterialSet:
                    moved.transportedCompactVssShareLinkageProofMaterial,
            };
        },
    ...
    },
    {
        ...
        proofRecordObjectType: 'CompactVssSameSecretBridgeProofRecord',
        ...
        moveEmbeddedToTransport: (proofMaterialSet: JsonRecord) => {
            ...
            return {
                proofMaterialSet: moved.proofMaterialSet,
                transportedProofMaterialSet:
                    moved.transportedCompactSameSecretBridgeProofMaterial,
            };
        },
        identityFields: sameSecretBridgeIdentityFields,
    },
] as const satisfies readonly CompactProofMaterialCase[];
...
const embeddedCompactProofMaterialSet = (
    compactCase: CompactProofMaterialCase,
    recordCount: number,
): JsonRecord => {
...
describe('compact VSS proof material move to transport', () => {
    it.each(compactProofMaterialCases)(
        'moves $proofFamily embedded proof bytes onto the streamable transport',
        (compactCase) => {
            const embedded = embeddedCompactProofMaterialSet(compactCase, 2);
    ...
    it.each(compactProofMaterialCases)(
        ...
        (compactCase) => {
            const embedded = embeddedCompactProofMaterialSet(compactCase, 1);
