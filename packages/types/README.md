...
This package is the single source of truth for the public type surface shared across `sealed-lattice`, `@sealed-lattice/protocol`, and `@sealed-lattice/wasm`. Workspace packages import from `@sealed-lattice/types` directly.
